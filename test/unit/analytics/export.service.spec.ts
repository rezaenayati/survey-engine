...
describe('ExportService', () => {
  ...
  describe('convertToCSV', () => {
    it('returns a string', () => {
      expect(typeof service.convertToCSV(minimalAnalytics)).toBe('string');
    });
        ...
        questions: [
          {
            ...
            isLegacy: false,
            distribution: [
              { value: 'red', label: 'Red', count: 3, percentage: 60, isLegacy: false },
              { value: 'blue', label: 'Blue', count: 2, percentage: 40, isLegacy: false },
            ],
          },
        ],
      };
