        ...
        },
        {
            ...
            elements: [
                ...
                },
                {
                    name: 'screenshot',
                    type: 'file',
                    title: 'Optional: upload a screenshot (uses survey-engine local file storage)',
                    description:
                        'Files are sent to the API as uploads, not embedded as base64.',
                    isRequired: false,
...
export default function NewSurveyPage() {
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        try {
            ...
            if (!id) {
                throw new Error('Invalid create survey response');
            }
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
                ...
                >
                    ...
                    <p className="text-xs text-gray-400 bg-gray-50 rounded-lg p-3">
                        A starter <strong>Customer Feedback</strong> template
                        will be pre-loaded. You can edit the full JSON schema on
                        the next page.
                    </p>
